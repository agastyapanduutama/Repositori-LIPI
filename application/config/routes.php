...
$route['karya/tahun/(:any)'] = 'C_karya/tahun/$1';
$route['karya/tahun/(:any)/(:any)'] = 'C_karya/tahun/$1/$2';
$route['karya/satuan/(:any)'] = 'C_karya/satuan/$1';
$route['karya/satuan/lebih/(:any)'] = 'C_karya/satuan/';
$route['karya/publikasi/(:any)'] = 'C_karya/karyaSatuan/$1';
$route['karya/publikasi/(:any)/(:any)'] = 'C_karya/karyaSatuan/$1/$2';
$route['karya/satker/(:any)'] = 'C_karya/karyaSatuan/$1';
$route['karya/satker/(:any)/(:any)'] = 'C_karya/karyaSatuan/$1/$2';
$route['karya/subjek/(:any)'] = 'C_karya/karyaSatuan/$1';
$route['karya/subjek/(:any)/(:any)'] = 'C_karya/karyaSatuan/$1/$2';
