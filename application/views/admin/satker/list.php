...
<div class="card">
    <div class="card-body">
        <div class="table-responsive">
            <table id="list_satker" class="table table-striped table-bordered" style="width:100%">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Satuan kerja</th>
...
<div class="modal fade" tabindex="-1" role="dialog" id="modalEdit">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="formEditSatker">
                <div class="modal-body">
                    
                    <input type="hidden" name="id_satker" id="idData">
                    
                    <div class="form-group">
                        <label>Satker</label>
                        <input type="text" name="nama_satker" id="nama_satker1" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Keterangan</label>
